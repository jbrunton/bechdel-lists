    ...
    <p>
      <ul>
        ...
        <li>A non-trivial, cleanly architected backend
          <a href="https://github.com/jbrunton/bechdel-lists/tree/develop/api">API</a> written using <b>Express</b>.
        </li>
        <li>A cleanly written <a href="https://github.com/jbrunton/bechdel-lists/tree/develop/client">client app</a> using
        <b>Vue.js</b>
        </li>
      </ul>
    </p>
